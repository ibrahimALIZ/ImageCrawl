...
public class PageFetcher extends Configurable {
	...
	public PageFetchResult fetchHeader(WebURL webUrl) {
		...
		try {
			...
			// Log.v("WebCrawler", "Fatal transport error: " + e.getMessage()
			...
			if (e.getMessage() == null) {
				// Log.v("WebCrawler", "Error while fetching " +
				// webUrl.getURL());
			} else {
				// Log.v("WebCrawler", e.getMessage() + " while fetching "
				// + webUrl.getURL());
			}
		} finally {
			try {
